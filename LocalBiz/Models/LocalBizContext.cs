    ...
    public class LocalBizContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Resto>()
                .HasData(
                    new Resto { RestoId = 1, RName = "Wok With Me", RAddress = "#1 Happy Street, Chicago, IL", RType = "Restaurant - Chinese", RUrl = "info@wokwithme.com"},
                    new Resto { RestoId = 3, RName = "Panera", RAddress = "#455 Michigan Avenue, Chicago, IL", RType = "Restaurant - American", RUrl = "info@panera.com"},
